...
当前源码版本：**MoonMeter 1.3.3**。本版将桌面导航、概览信息层级、本地 Session 来源和 Codex 额度职责收敛到更清晰的控制台，同时修复 Windows 代理环境下官方价格目录同步失败问题，并继续保持所有本地数据控制在用户设备上。详见 [CHANGELOG.md](./CHANGELOG.md)。
