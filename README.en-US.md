...
Current source version: **MoonMeter 1.3.4**. This release strengthens official pricing catalog synchronization behind Windows proxies with system-proxy, DNS, connection-pool recovery, and bounded retries, while keeping user data on the device. See [CHANGELOG.md](./CHANGELOG.md).
