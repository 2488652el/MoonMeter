<div align="center">
  ...
  <p>
    <img alt="Version" src="https://img.shields.io/badge/version-1.3.3-151515?style=flat-square" />
...
```powershell
npm run dist:win -- --change "MoonMeter-1.3.3" --model "release"
```

Output:

```text
demo/moonmeter-1.3.3-MoonMeter-1.3.3-release/
```
...
Current source version: **MoonMeter 1.3.3**. This release consolidates desktop navigation, dashboard information hierarchy, local Session sources, and Codex quota ownership into a clearer control center, while fixing official pricing catalog sync behind Windows proxies and keeping user data on the device. See [CHANGELOG.md](./CHANGELOG.md).
