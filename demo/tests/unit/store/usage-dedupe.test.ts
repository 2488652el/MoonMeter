...
vi.mock('../../../../code/src/main/store/db', async (importOriginal) => ({
  ...(await importOriginal<typeof import('../../../../code/src/main/store/db')>()),
  getDb: () => usageDb.current
}))

import { applyMigrationsForTest } from '../../../../code/src/main/store/db'
import { insertUsage } from '../../../../code/src/main/store/usage-repo'
 ...
 * (see code/src/main/store/db.ts v2 migration). These tests verify the dedup
